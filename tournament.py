...
class World:
    ...
    def _clear_area(self, x, y):
        ...
        self.worldmap[y-1][x] = ASCII_TILES["empty"]
        self.worldmap[y+1][x] = ASCII_TILES["empty"]
        self.worldmap[y][x-1] = ASCII_TILES["empty"]
        self.worldmap[y][x+1] = ASCII_TILES["empty"]
...
class AgentEngine:
    ...
    def terminate(self, reason):
        ...
        self.agent.__terminate__(reason)
    ...
    def control(self, world):
        action, direction = self.agent.__update__(self.get_visible_world(world), self.position, self.can_shoot, self.holding_flag)
    ...
    def collision(self, world):
        ...
        # flag capturing / collision
            ...
            if world.worldmap_buffer[y][x] == ASCII_TILES["red_flag"]:
            ...
            if world.worldmap_buffer[y][x] == ASCII_TILES["blue_flag"]:
